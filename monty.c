...
int main(int argc, char **argv)
{
  ...
  // If no file monty or more than 2 parameters (file monty + other parameter)
  if (argc < 2 || argc > 2)
  {
  ...
  // If it's not possible open file monty
  ...
  //Initialize Stack
  //Stack = initStack(file_fd);

  //Read file bytecode monty at end
